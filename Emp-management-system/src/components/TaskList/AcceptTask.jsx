...
export default function AcceptTask({data}) {
  ...
  return (
    <div>
      <div className="p-4 border border-white flex flex-col gap-4 justify-between h-full">
        ...
        <div className="flex justify-between gap-4 flex-col">
          <button className="cursor-pointer px-4 py-2 w-full border  text-green-300">
            Mark as Complete
          </button>
